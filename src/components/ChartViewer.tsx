...
import { FaSearch, FaHistory, FaStar, FaChartLine } from 'react-icons/fa';
            ...
            <div className="h-full flex flex-col items-center justify-center">
              <div className="relative w-full max-w-sm">
                ...
                {showDropdown && searchInput && (
                  <div className="absolute mt-1 w-full bg-gray-700 rounded-lg shadow-lg 
                    border border-gray-600 overflow-hidden z-50">
              ...
              <FaChartLine className="mt-4 text-2xl text-gray-400" />
              <p className="mt-2 text-gray-400">Click to add chart</p>
            </div>
          )}
        </div>
      ) : (
